      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {specialOffers.map((offer, index) => (
            <div 
              key={offer.id}
              className={`bg-white rounded-xl overflow-hidden shadow-lg flex flex-col md:flex-row transform transition duration-500 ease-in-out hover:-translate-y-1 hover:shadow-xl ${
                index % 2 === 0 ? 'animate-fade-in' : 'animate-fade-in-delayed'
              }`}
            >
